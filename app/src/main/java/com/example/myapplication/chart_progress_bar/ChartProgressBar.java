package com.example.myapplication.chart_progress_bar;
...
public class ChartProgressBar extends FrameLayout {
    ...
    private final ArrayList<TextView> pins = new ArrayList<>();
    ...
    public void build() {
        ...
        /*LinearLayout horizontalLinesLayout = new LinearLayout(mContext);
        LinearLayout.LayoutParams horizontalLinesLayoutParams = new LinearLayout.LayoutParams(
                LayoutParams.MATCH_PARENT,
                LayoutParams.MATCH_PARENT
        );
        horizontalLinesLayout.setOrientation(LinearLayout.VERTICAL);
        horizontalLinesLayout.setBackgroundColor(mBarTitleColor);
        horizontalLinesLayout.setLayoutParams(horizontalLinesLayoutParams);

        for (i = 0; i < 5; i++) {
            View horizontalLine = new View(mContext);
            LayoutParams horizontalLineParams = new LayoutParams(
                    LayoutParams.MATCH_PARENT,
                    2
            );
            horizontalLine.setBackgroundColor(mProgressColor);
            horizontalLine.setLayoutParams(horizontalLineParams);

            horizontalLinesLayout.addView(horizontalLine);
        }
        addView(horizontalLinesLayout);*/
...
//        emptyLayer.setCornerRadius(mBarRadius);
        emptyLayer.setCornerRadii(new float[]{0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f});
...
//            progressLayer.setCornerRadius(1);
            progressLayer.setCornerRadii(new float[]{30f, 0f, 30f, 30f, 30f, 30f, 30f, 0f});
        }
        ...
        LinearLayout linesLayout = new LinearLayout(mContext);
        LinearLayout.LayoutParams linesLayoutParams = new LinearLayout.LayoutParams(
                LayoutParams.MATCH_PARENT,
                mBarHeight
        );

        linesLayoutParams.gravity = Gravity.START;
        linesLayout.setLayoutParams(params);
        linesLayout.setOrientation(LinearLayout.VERTICAL);
//        linesLayout.setGravity(Gravity.CENTER);
//        linesLayout.setBackgroundColor(mProgressClickColor);
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if ((i % 2 == 0)) {
                ...
                horizontalLine.setBackgroundColor(mBarTitleSelectedColor);
            }

            horizontalLine.setLayoutParams(horizontalLineParams);
            linesLayout.addView(horizontalLine);
...
//        rootFrameLayout.addView(linesLayout);
